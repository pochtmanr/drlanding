...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("meta.sportsInjuryPrevention.title"),
    description: t("meta.sportsInjuryPrevention.description"),
    path: "/patient-info/articles/sports-injury-prevention",
  });
}

export default async function SportsInjuryPreventionPage({
  params,
}: {
