...
import { article } from "@/content/patient-info/articles/return-to-sport";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("meta.returnToSport.title"),
    description: t("meta.returnToSport.description"),
    path: "/patient-info/articles/return-to-sport",
  });
}
