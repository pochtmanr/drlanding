...
import { content } from "@/content/services/arthroscopy/knee";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.knee.metaTitle"),
    description: t("pages.knee.metaDescription"),
    path: "/services/arthroscopic-surgery/knee",
  });
}

export default async function ArthroscopyKneePage({
  params,
}: {
