...
import { content } from "@/content/services/arthroscopy/rehabilitation";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    path: "/services/arthroscopic-surgery/rehabilitation",
  });
}

export default async function ArthroscopyRehabilitationPage({
  params,
}: {
