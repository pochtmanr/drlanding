...
import { content } from "@/content/services/arthroscopy/elbow";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.elbow.metaTitle"),
    description: t("pages.elbow.metaDescription"),
    path: "/services/arthroscopic-surgery/elbow",
  });
}

export default async function ArthroscopyElbowPage({
  params,
}: {
