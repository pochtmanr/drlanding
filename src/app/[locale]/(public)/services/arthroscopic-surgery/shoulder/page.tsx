...
import { content } from "@/content/services/arthroscopy/shoulder";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.shoulder.metaTitle"),
    description: t("pages.shoulder.metaDescription"),
    path: "/services/arthroscopic-surgery/shoulder",
  });
}

export default async function ArthroscopyShoulderPage({
  params,
}: {
  ...
  const related = [
    ...
    { label: t("cards.preparation.title"), href: "/services/arthroscopic-surgery/preparation" },
