...
import { content } from "@/content/services/arthroscopy/ankle-foot";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.ankleFoot.metaTitle"),
    description: t("pages.ankleFoot.metaDescription"),
    path: "/services/arthroscopic-surgery/ankle-foot",
  });
}

export default async function ArthroscopyAnkleFootPage({
  params,
}: {
