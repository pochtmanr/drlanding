...
import { content } from "@/content/services/arthroscopy/insurance-forms";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.insuranceForms.metaTitle"),
    description: t("pages.insuranceForms.metaDescription"),
    path: "/services/arthroscopic-surgery/insurance-forms",
  });
}

export default async function ArthroscopyInsuranceFormsPage({
  params,
}: {
