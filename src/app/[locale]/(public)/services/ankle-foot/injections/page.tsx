...
import { content } from "@/content/services/ankle/injections";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    path: "/services/ankle-foot/injections",
  });
}

export default async function AnkleInjectionsPage({
  params,
}: {
  ...
  const related = [
    { label: t("links.jointInjections"), href: "/services/joint-injections" },
