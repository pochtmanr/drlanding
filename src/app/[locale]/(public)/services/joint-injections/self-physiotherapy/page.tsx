...
import { content } from "@/content/services/injections/self-physiotherapy";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.selfPhysiotherapy.metaTitle"),
    description: t("pages.selfPhysiotherapy.metaDescription"),
    path: "/services/joint-injections/self-physiotherapy",
  });
}

export default async function SelfPhysiotherapyPage({
  params,
}: {
