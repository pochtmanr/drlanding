...
import { content } from "@/content/services/injections/prp-hyaluronic-combined";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.prpHyaluronicCombined.metaTitle"),
    description: t("pages.prpHyaluronicCombined.metaDescription"),
    path: "/services/joint-injections/prp-hyaluronic-combined",
  });
}

export default async function PrpHyaluronicCombinedPage({
  params,
}: {
