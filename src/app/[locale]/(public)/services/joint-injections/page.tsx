...
const subpages = [
  { key: "prpHyaluronicCombined", href: "/services/joint-injections/prp-hyaluronic-combined" },
  { key: "prp", href: "/services/joint-injections/prp" },
  { key: "orthokine", href: "/services/joint-injections/orthokine" },
  { key: "hyaluronicAcid", href: "/services/joint-injections/hyaluronic-acid" },
  { key: "steroid", href: "/services/joint-injections/steroid" },
  { key: "insuranceForms", href: "/services/joint-injections/insurance-forms" },
  { key: "selfPhysiotherapy", href: "/services/joint-injections/self-physiotherapy" },
] as const;
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    path: "/services/joint-injections",
  });
}

export default async function JointInjectionsPage({
  params,
}: {
