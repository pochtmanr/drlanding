...
import { content } from "@/content/services/injections/insurance-forms";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    path: "/services/joint-injections/insurance-forms",
  });
}
...
export default async function InsuranceFormsPage({
  ...
  const related = [
    ...
    { label: t("cards.selfPhysiotherapy.title"), href: "/services/joint-injections/self-physiotherapy" },
  ];
