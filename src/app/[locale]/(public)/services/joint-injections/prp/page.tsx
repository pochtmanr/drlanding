...
import { content } from "@/content/services/injections/prp";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.prp.metaTitle"),
    description: t("pages.prp.metaDescription"),
    path: "/services/joint-injections/prp",
  });
}
...
export default async function PrpPage({
  ...
  const related = [
    ...
    { label: t("cards.orthokine.title"), href: "/services/joint-injections/orthokine" },
