...
import { content } from "@/content/services/knee/injections-vs-surgery";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return buildMetadata({
    ...
    title: t("pages.injectionsVsSurgery.metaTitle"),
    description: t("pages.injectionsVsSurgery.metaDescription"),
    path: "/services/knee/injections-vs-surgery",
  });
}

export default async function KneeInjectionsVsSurgeryPage({
  params,
}: {
